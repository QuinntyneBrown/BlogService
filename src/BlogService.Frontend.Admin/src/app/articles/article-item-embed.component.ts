...
const template = require("./article-item-embed.component.html");
const styles = require("./article-item-embed.component.scss");

export class ArticleItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new ArticleDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new ArticleEdit(this.entity));
    }
...
customElements.define(`ce-article-item-embed`,ArticleItemEmbedComponent);
