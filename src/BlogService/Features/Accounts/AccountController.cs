...
using static BlogService.Features.Accounts.AddOrUpdateAccountCommand;
using static BlogService.Features.Accounts.GetAccountsQuery;
using static BlogService.Features.Accounts.GetAccountByIdQuery;
using static BlogService.Features.Accounts.RemoveAccountCommand;

namespace BlogService.Features.Accounts
{
    [Authorize]
