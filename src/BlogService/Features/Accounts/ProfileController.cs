...
using static BlogService.Features.Accounts.AddOrUpdateProfileCommand;
using static BlogService.Features.Accounts.GetProfilesQuery;
using static BlogService.Features.Accounts.GetProfileByIdQuery;
using static BlogService.Features.Accounts.RemoveProfileCommand;
